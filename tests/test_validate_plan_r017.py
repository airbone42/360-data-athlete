"""Tests for validate_plan.py R017 — Weekly Hard-Reize cap.

R017 was renumbered from R009 to resolve the rule-id collision with
check_hr_range_consistency (which keeps R009).
"""
...
BALANCE_RUN_DONE_RIDE_OPEN = (
    "Hard-stimuli balance (rolling 7d 2025-05-17–2025-05-23, "
    "2-stimuli strategy per training_paradigms.md §93–96):\n"
    "✓ Run threshold/VO2max: 2025-05-19 \"Threshold 5×6 Z4\" (Z4+Z5 21 min)\n"
    "⚠️ Bike VO2max: open"
)
...
BALANCE_RIDE_DONE_RUN_OPEN = (
    "Hard-stimuli balance (rolling 7d):\n"
    "⚠️ Run threshold/VO2max: open\n"
    "✓ Bike VO2max: 2025-05-21 \"Rønnestad 30/15\" (Z4+Z5 18 min)"
)
...
def test_r017_fires_for_second_run_hardreiz_in_week():
...
def test_r017_silent_on_easy_z2_run():
...
def test_r017_silent_when_balance_empty():
...
def test_r017_silent_when_slot_still_open():
...
def test_r017_silent_on_cross_system_no_double():
...
def test_r017_silent_when_taper_active_in_athlete_status():
...
def test_r017_silent_when_race_week_active_in_coaching_notes():
