...
class ContextDict(BaseModel):
    ...
    rhr_context: Any = Field(None, alias="rhrContext")
    rhr_baseline: Any = Field(None, alias="rhrBaseline")
    rhr_deviation: Any = Field(None, alias="rhrDeviation")
    combined_overload_signal: Any = Field(None, alias="combinedOverloadSignal")
